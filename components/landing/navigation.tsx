...
const navLinks = [
  { name: "Strategy",      href: "#features"      },
  { name: "Philosophy",    href: "#how-it-works"  },
  { name: "Testimonials",  href: "#testimonials"  },
  { name: "Access",        href: "#cta"           },
      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>JXC</span>
            <span className={`font-mono transition-all duration-500 ${isScrolled ? "text-[10px] mt-0.5 text-muted-foreground" : "text-xs mt-1 text-white/60"}`}>Capital</span>
          </a>
