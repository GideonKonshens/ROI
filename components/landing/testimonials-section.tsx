...
const testimonials = [
  {
    quote: "JXC&apos;s algorithmic + discretionary approach to gold trading is exceptional. Their sniper entry model consistently identifies high-probability setups. The discipline is unmatched.",
    author: "Marcus O.",
    role: "Institutional Investor",
    company: "East Africa Capital",
    metric: { value: "16.8%", label: "Average annual return" },
  },
  {
    quote: "What impressed me most is their strict ATR-based risk management. Every position is sized correctly from entry. Capital preservation is clearly their priority.",
    author: "Amara K.",
    role: "Strategic Partner",
    company: "Global Asset Management",
    metric: { value: "99.2%", label: "Trade win rate" },
  },
  {
    quote: "Their trend alignment system removes all guesswork. They trade with momentum, not against it. The results speak for themselves.",
    author: "James Nyawire",
    role: "Private Investor",
    company: "Kenya Wealth Partners",
    metric: { value: "8+", label: "Years consistent performance" },
  },
  {
    quote: "Consistency over intensity—exactly what I needed. Their philosophy of controlled growth without excessive risks has been transformative for my capital.",
    author: "Fatima Ahmed",
    role: "Family Office Manager",
    company: "Pan-African Wealth",
    metric: { value: "14-18%", label: "Annual returns" },
  },
];
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              <span className="text-background/40"> globally.</span>
            </h2>
          </div>
